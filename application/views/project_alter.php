    ...
    <div class="configure">
        <div class="panel panel-default" style="width:400px;float:left;">
            <div class="panel-body" style="">
                <div style="font-size:12pt;margin-bottom:5px;">项目基本信息
                </div>
                <table class="table" style="margin-bottom: 10px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="project_rate" value="<?php echo $rate;?>" class="form-control">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="project_priority" value="<?php echo $rate;?>" class="form-control">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group has-feedback" style="margin-bottom:0px;">
                                    <input id="project_cookie" value="<?php echo $cookie; ?>" type="text" class="form-control" placeholder="请输入Cookie">
                                    <span class="form-control-feedback"></span>
                                </div>
                            </td>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group has-feedback"  style="margin-bottom:0px;">
                                    <span class="input-group-addon">#</span>
                                    <input id="list_regex" value="<?php echo $list_regex;?>"  type="text" class="form-control" placeholder="请输入过滤正则表达式">
                                    <span class="form-control-feedback"></span>
                                </div>
                            </td>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group has-feedback">
                                    <span class="input-group-addon">$</span>
                                    <input id="detail_src" value="<?php echo $detail_src;?>" type="text" class="form-control" placeholder="请输入筛选路径">
                                    <span class="form-control-feedback"></span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="input-group has-feedback">
                                    <span class="input-group-addon">$</span>
                                    <input id="detail_author" value="<?php echo $detail_author;?>" type="text" class="form-control" placeholder="请输入筛选路径">
                                    <span class="form-control-feedback"></span>
                                </div>
                            </td>
                        </tr>
									...
									<td>
										<div class="input-group has-feedback">
											<span class="input-group-addon">$</span>
											<input id="video_find" type="text"   value='<?php echo $video_find;?>' class="form-control" placeholder="请输入筛选路径,非视频类网站为空即可">
											<span class="form-control-feedback"></span>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="input-group has-feedback">
											<span class="input-group-addon">$</span>
											<input id="video_src" type="text"   value="<?php echo $video_src;?>" class="form-control" placeholder="比如 href src value等,非视频类网站为空即可">
											<span class="form-control-feedback"></span>
										</div>
									</td>
								</tr>
...
<div class="toolbar">
    <div class="panel panel-default" style="clear:both; border-color:#aaa; margin-bottom:0px;">
        <div class="panel-body" style="padding:5px 10px;">
            ...
            <button id="btn_alter" type="button" onclick="javascript:AlterProject();"style="float:right"class="btn btn-warning">修改项目</button>
        </div>
    </div>
    ...
    <div class="panel panel-default" style="clear:both; border-color:#aaa; margin:10px 0px;">
        <div class="panel-heading">运行结果  &nbsp;&nbsp;&nbsp; <a target="_blank" href="/debugger/Preview" onclick="javascript:AlterPreviewState()">预览抓取结果</a></div>
    ...
    <div class="panel panel-default">
        ...
        <button id="btn_reset" type="button" onclick="javascript:ResetProject();"style="float:left"class="btn btn-danger">重置拦截状态</button>
        </div>
    </div>
    <div class="panel panel-default">
...
function ResetProject()
{
    $.ajax({
        ...
        success: function(data) {
            TaskConsole.Log('<span style="font-weight:bold;">重置拦截状态成功!</span>');
        },
        complete: function () {
            $("#btn_reset").removeAttr("disabled");
        },
        error: function(e) {
            TaskConsole.Log('<span style="font-weight:bold;color:red">重置拦截状态失败: status('+e.status+') </span>');
        }
    });
}
...
function AlterProject()
{
    ...
    {
        TaskConsole.Log('<span style="font-weight:bold;color:red">修改项目失败:未进行预览</span>');
        return;
    }
    ...
    $.ajax({
        ...
        beforeSend: function () {
            $("#btn_alter").attr({ disabled: "disabled" });
        },
        success: function(data) {
            if(data['error'] != '')
            {
